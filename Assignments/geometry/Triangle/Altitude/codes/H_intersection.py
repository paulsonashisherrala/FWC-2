...
A = np.array([[9,4],[8,1]])             #Defining the vector A
B = np.array([15,32])                     #Defining the vector B
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/sdcard/Download/Internship/FWC-2/Assignments/geometry/Triangle/Altitude/figs/H_intersection.png')
plt.show()
